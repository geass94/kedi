...
public class HttpServletRequestDebug {
    ...
    /** The Constant LOGGER. */
    private static final Logger LOGGER = LoggerFactory.getLogger(HttpServletRequestDebug.class.getName());

//    public HttpServletRequestDebug() {
//        FileHandler fh;
//
//        try {
//
